...
<%
 ...
 <% if(user!=null){ %>
<%if (c>0){ %><a href="JSP/ChecoutSJSP.jsp" class="submit">Procedi all'Acquisto</a><%} else { %>
	<a href="JSP/ChecoutJSP.jsp" class="submit">Procedi all'Acquisto</a><%}}
 else{ %> <p style="color:red">Effettuare l'accesso prima di proseguire con l'acquisto</p><a class="submit" href="JSP/LoginJSP.jsp">Accedi</a><%}} %>
