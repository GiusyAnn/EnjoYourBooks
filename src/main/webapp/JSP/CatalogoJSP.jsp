...
<%
	...
	if(libro == null){ %>
	<h2>Nessun Libro Trovato</h2> <% } else{ 
...
<form action="bookServlet" method="post"><button value="<%=l.getISBN() %>" name="ISBN" class="flip-card w3-col l3 m6 w3-margin-bottom" style="width:300px;height:295px; border:none; cursor:pointer"  >
  <div class="flip-card-inner" style="width:250px;height:350px">
    <div class="flip-card-front" style="width:250px;height:350px">
      <img src="<%=l.getCopertina() %>" alt="Avatar" style="width:250px;height:350px;">
    </div>
	...
	<% }else { %>
		<form action="bookServlet" method="get"><button value="<%=l.getISBN() %>" name="ISBN" class="flip-card w3-col l3 m6 w3-margin-bottom" style="width:300px;height:295px; border:none; cursor:pointer"  >
		  <div class="flip-card-inner " style="width:250px;height:350px">
		    <div class="flip-card-front " style="width:250px;height:350px">
