...
<div class="tab">Credenziali Utente:
	<%if(error!=null) {%>
    <p id="error"><%=error %></p>  
    <p><input placeholder="Username" oninput="this.className = ''" name="Username" id="user" class="input error"></p>
    <p><input placeholder="Password" oninput="this.className = ''" id="myInput" name="Password" type="password" class="input error"
...
<%} %>
  ...
  <div class="tab"> Immagine del Profilo:
  <label class=" w3-col l3 m6 w3-margin-bottom nopad">
