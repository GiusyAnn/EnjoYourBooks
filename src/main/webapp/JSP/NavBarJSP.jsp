...
<div class="topnav" id="myTopnav">
  <a href="HomeJSP.jsp" class="active hover-white"><img src="../Img/nlogo.png" ></a>
...
<span class="rht">
  ...
  <div class="overlay-content">
    <form action="../cercaLibriServlet" method="post">
      ...
      <button type="submit" ><img src="../Img/lupa.png" class="fa fa-search "></button>
    </form>
  </div>
</div>
...
<% if (user == null) {%>
<a href="LoginJSP.jsp" onclick="preaccesso()" class="hover-white"><span><img src="../Img/mer.png"></span>
<% if(dim>0){ %><span class="badge"><%=dim %></span><%} %></a>
  <a href="LoginJSP.jsp">Accedi</a>
  <a href="LoginJSP.jsp" onclick="preaccesso()">Pubblica</a>
  <% } else { %>
 <%if(user.getrole().equalsIgnoreCase("Utente")){ %>
  <a href="CarrelloINJSP.jsp" class="hover-white"><span><img src="../Img/mer.png"></span>
  <% if(dim>0){ %><span class="badge"><%=dim %></span><%} %></a><%} %>
  <a href="UserINJSP.jsp">Area Personale</a>
   <span class="dropdown"><form action ="../logoutServlet" method="GET"><button style="margin-top:4px;" class="dropbtn" >Logout</button> </form></span>
  <a href="PubblicaJSP.jsp">Pubblica</a><%} %>
  
  <div class="dropdown">
    <form action ="../catalogoServlet" method="POST"><button class="dropbtn">Letture</button></form>
   <form action="../catalogoGenereServlet" method="POST"><div class="dropdown-content">
